    ...
    return (
        <>
            ...
            <div className="container">
                <div className="info-contact text-center text-white mt-4">
                ...
                <div className="box-text-detail mt-5" style={{ display: 'flex', justifyContent: 'space-between' }} >
                    <div className="box-1 text-white" style={{ border: '1px solid #fff', width: '630px', padding: '30px', borderRadius: '10px', boxShadow: '0 0 0 5px' }}>
                        <p>อาคารที่ 6 /25 - 26 ซอยเพชรเกษม 110 ถนนเพชรเกษม แขวงหนองค้างพลู เขตหนองแขม กรุงเทพมหานคร 10160</p>
                    </div>

                    <div className="box-2 text-white" style={{ border: '1px solid #fff', width: '630px', padding: '30px', borderRadius: '10px', boxShadow: '0 0 0 5px' }}>
